...
class DraftsConfig(AppConfig):
    ...
    table_chain = TableChain(verbose=verbose, table_template=table_template)
    keywords_chain = KeywordsChain(verbose=verbose, keywords_template=keywords_template)
    draft_chain = DraftChain(verbose=verbose, draft_template=draft_template)
